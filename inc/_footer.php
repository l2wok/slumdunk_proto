...
<footer id="j-footer" class="mt-auto bg-black">
    <div class="container d-lg-none pt-1">
        <div class="last d-flex align-items-center justify-content-between">
            <a href="<?php echo $data['pref']; ?>profile.php" class="w-50 py-2 d-inline text-center">Ваш профиль</a>
            <a href="<?php echo $data['pref']; ?>backet.php" class="w-50 py-2 d-inline text-center">Корзина 
    ...
    <div class="container pt-2">
        <div class="d-flex flex-row justify-content-between">
            <div class="footer-logo d-flex align-items-center">
                <a class="logo-f" href="<?php echo $data['pref']; ?>" title="В начало">
            ...
            <div class="footer-links d-lg-flex align-items-center flex-row-reverse">
                <a id="go-to-top" href="#" class="btn btn-sm border-light"> Наверх</a>
                <a href="#" class="block-item">Политика конфиденциальности</a>
                <a href="#" class="">Юридическая информация</a>
                <p>2019&nbsp;&COPY;&nbsp;Slamdunk.su</p>
            </div>
        </div>
    </div>
</footer>
