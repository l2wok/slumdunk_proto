...
<html lang="ru">
    <head>
        ...
        <link rel="stylesheet" href="assets/css/proto_styles_large.css">
    ...
    <body>
        ...
        <header class="fixed-top">
            <div class="topCollapsedMenu" id="hiddenTopMenu">
                    <div id="phoneCall" class="collapse" data-parent="#hiddenTopMenu">8-80000-545-45-3-53</div>
                    <div id="userProfileTop" class="collapse" data-parent="#hiddenTopMenu">user profiler</div>
            </div>
            
            <div class="bg-light collapse" id="userPanel">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4 p-2">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <a class="btn btn-sm btn-outline-warning text-dark"><i class="fas fa-trash-alt"></i></a>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <a class="btn btn-sm btn-outline-warning"><i class="fas fa-check-square"></i> Оформить заказ</a>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!--                    <a href="/" class="navbar-brand d-flex align-items-center mr-auto">
                        <div class="logo">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 73 71.88" width="46" height="46">
                    ...
                    <a class="mr-1 collapsed" data-toggle="collapse" data-target="#phoneCall" aria-expanded="false" aria-controls="phoneCall" href="#">
...
<!--                    <button class="navbar-toggler collapse" type="button" data-toggle="collapse"
                            data-target="#userPanel" aria-controls="userPanel" aria-expanded="false" aria-label="Toggle userPanel">
                        <i class="fa fa-user mr-3"></i>&nbsp;<i class="fa fa-shopping-cart ml-2"></i>
                        <span class="badge badge-transparent in-cart">1</span>
                    </button>-->
                </div>
            </div>
        ...
        <div id="carousel" class="d-none d-sm-none d-md-none d-lg-block col-lg-12 carousel slide" data-ride="carousel" style="overflow: hidden">
            ...
            <div class="carousel-inner container">
                <div class="carousel-item active" data-interval="10000">
                    <div class="carousel-caption">
                        ...
                        <p class="">С доставкой в удобное для вас время</p>
                        <a class="btn btn-dark mt-2" href="#">СМОТРЕТЬ КАТАЛОГ</a>
                    </div>
                </div>
                <div class="carousel-item" data-interval="10000" >
                    <div class="carousel-caption">
                        ...
                        <a class="btn btn-dark mt-2" href="#">ВЫБИРАТЬ ЛУЧШИЕ ТОВАРЫ</a>
                    </div>
                </div>
                <div class="carousel-item" data-interval="10000">
                    <div class="carousel-caption">
                        <h1>В ТАКОЙ ОБУВИ ВИДНО ТОЛЬКО ТВОЮ СПИНУ</h1>
                        <p class="">Потому что ты рилли быстрый</p>
                        <p class="lead">как ебаный орёл</p>
                        <a class="btn btn-dark mt-2" href="#">ЛЕТАТЬ КАК ВЕТЕР</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row text-white">
                    <div class="col-12 d-flex justify-content-center pt-1 mb-1">
                        <a class="infolink text-right" href="#">Юридическая информация</a>
                        <a class="infolink" href="#">Все права защищены</a>
                        <a class="infolink text-left" href="#">Политика конфиденциальности</a>
                    </div>
