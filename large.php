    ...
    <body>
            ...
            <div class="topCollapsedMenu" id="hiddenTopMenu">
                <div id="search" class="collapse" data-parent="#hiddenTopMenu">
                    <div class="container">
                        <div class="row">
                            <!-- pt-4 pb-2-->
                            <h3 class=" w-100"> Введите наименование интересующего вас товара или фирмы в строку поиска.</h3>
                            <!--mt-3 mb-2-->
                            <div class="col-6 offset-3 input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn " type="button">OКЕЙ ГУГАЛ ...</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="phoneCall" class="collapse" data-parent="#hiddenTopMenu">
                    <div class="container">
                        <div class="row">
                            <!--pt-4 pb-2-->
                            <h3 class=" w-100"> Позвоните нам по бесплатному номеру 8-80000-545-45-3-53 
                                <!--mb-2-->
                                <a class="btn "> Набрать чичас!</a></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <p>Для оформления заказа ребуется 
                                    <!--mb-1-->
                                    <a class="btn ">войти</a> или Вы можете <br>войти через соц.сети: 
                                    <a class="btn ">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a class="btn ">
                                ...
                                <p>Зарегистрировать новый аккаунт 
                                    <!--mb-1--> 
                                    <a class="btn ">можно тут</a></p>
                                <p>Позвоните нам по бесплатному номеру 
                                    <!--mb-1--> 
                                    <a class="btn ">8-800-555-35-35</a> если возникли вопросы.</p>
                            </div>
                            <!--pt-4 pb-2-->
                            <div class="col-sm-12 col-md-5">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <a class="btn "><i class="fas fa-check-square"></i> Оформить заказ</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="navbar">
                <div class="container d-flex flex-row justify-content-between">
                    ...
                    <div class="w-25 lastBlock d-flex align-self-start justify-content-end align-items-start mt-lg-0">
                        ...
                        <a class="collapsed btn mr-1 active" data-toggle="collapse" data-target="#phoneCall" aria-expanded="false" aria-controls="phoneCall" href="#">
                            <i class="fa fa-phone-volume"></i>
                        </a>
                        <a class="collapsed btn mr-1" data-toggle="collapse" data-target="#search" aria-expanded="false" aria-controls="search" href="#">
                            <i class="fa fa-search"></i>
                        </a>
                        <a class="collapsed btn " data-toggle="collapse" data-target="#userProfileTop" aria-expanded="false" aria-controls="userProfileTop" href="#">
            ...
            <div class="carousel-inner container">
                <div class="carousel-item active" data-interval="10000">
                    <div class="carousel-caption">
                        ...
                        <a class="btn mt-2" href="#">СМОТРЕТЬ КАТАЛОГ</a>
                    </div>
                </div>
                <div class="carousel-item" data-interval="10000" >
                    <div class="carousel-caption">
                        ...
                        <a class="btn mt-2" href="#">ВЫБИРАТЬ ЛУЧШИЕ ТОВАРЫ</a>
                    </div>
                </div>
                <div class="carousel-item" data-interval="10000">
                    <div class="carousel-caption">
                        ...
                        <a class="btn mt-2" href="#">ЛЕТАТЬ КАК ВЕТЕР</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container main">
            <div class="col-12 d-flex justify-content-center">
                <button class="btn ">НОВЫЕ ПОСТУПЛЕНИЯ</button>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                    <div class="card bigHeight">
            ...
            <div class="col-12 d-flex justify-content-center">
                <button class="btn ">КОЛЛЕКЦИИ</button>
            </div>
            <div class="row">
                    ...
                    <div class="card bigHeight ">
                        <div class="card-body ">
                            ...
                            <div class="ml-2 col-10">
                                <small class="">За эту обувь не жаль и Родину продать. Поэтому докажи свою лольность бренду и неси свои денюжки к нам.</small>
                            </div>
                            <a href="#" class="btn mt-3 ml-4">ПОДРОБНЕЕ</a><br>
                            <a href="#" class="btn ml-4 mt-3">КУПИТЬ</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 d-flex justify-content-center">
                <button class="btn ">ИЗБРАННЫЕ СТАТЬИ</button>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <a href="#" class=" no-decor">
                            <div class="card midHeight short_card d-flex align-content-between flex-wrap">
            ...
            <div class="col-12 d-flex justify-content-center">
                <button class="btn ">ЕЩЁ ТЕБЕ ПОНРАВИТСЯ</button>
            </div>
            <div class="offset-artem-designer-2019">
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <a href="#" class=" no-decor">
                            <div class="card midHeight short_card ">
                ...
                <div class="row smalHeight d-flex align-items-center">
                    ...
                    <div class="col-md-5 col-lg-3">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn border-dark" type="button" id="button-addon2">
        ...
        <div class="container">
            ...
            <div class="row btm_links">
                ...
                <div class="col-12">
                    <!-- mb-4-->
                    <h3 class="">ОЦЕНИТЕ НАС 
                        <a class="no-decor " href=""><i class="fab fa-instagram fa-1x ml-3"></i></a>
                        <a class="no-decor " href=""><i class="fab fa-vk fa-1x ml-3"></i></a>
                        <a class="no-decor " href=""><i class="fab fa-facebook fa-1x ml-3"></i></a>
                    </h3>
                </div>
            </div>
        </div>
        ...
        <footer class="">
            <div class="container">
                <div class="row ">
                    ...
                    <p class="w-100 p-2">&COPY; <?php echo date("Y"); ?> SLAMDUNK</p>
                </div>
            </div>
        </footer>
        <!-- ~~~~~~ END FOOTER ~~~~~ -->
