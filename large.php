            ...
            <div class="topCollapsedMenu" id="hiddenTopMenu">
                <div id="search" class="collapse" data-parent="#hiddenTopMenu">
                    <div class="container">
                        <div class="row">
<!--                             pt-4 pb-2-->
                            <h3 class="text-center w-100"> Введите наименование интересующего вас товара или фирмы в строку поиска.</h3>
                             <!--mt-3 mb-2-->
                            <div class="col-6 offset-3 input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-warning" type="button">OКЕЙ ГУГАЛ ...</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="phoneCall" class="collapse" data-parent="#hiddenTopMenu">
                    <div class="container">
                        <div class="row">
                             <!--pt-4 pb-2-->
                            <h3 class="text-center w-100"> Позвоните нам по бесплатному номеру 8-80000-545-45-3-53 
                                 <!--mb-2-->
                                <a class="btn btn-outline-warning"> Набрать чичас!</a></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <p>Для оформления заказа ребуется 
                                    <!--mb-1-->
                                    <a class="btn btn-outline-warning btn-sm">войти</a> или Вы можете <br>войти через соц.сети: 
                                ...
                                <p>Зарегистрировать новый аккаунт 
                                    <!--mb-1--> 
                                    <a class="btn btn-outline-warning btn-sm">можно тут</a></p>
                                <p>Позвоните нам по бесплатному номеру 
                                    <!--mb-1--> 
                                    <a class="btn btn-outline-warning btn-sm">8-800-555-35-35</a> если возникли вопросы.</p>
                            </div>
                             <!--pt-4 pb-2-->
                            <div class="col-sm-12 col-md-5">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <!--text-dark-->
                                        <a class="btn btn-sm btn-outline-warning"><i class="fas fa-trash-alt"></i></a>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
...
<!--        overflow:hidden style-->
        ...
        <div class="container main">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                    <div class="card bigHeight bg-light">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-md-4 col-lg-2 mb-1">
                    <div class="card bigHeight bg-darks text-white">
                ...
                <div class="col-sm-4 col-md-4 col-lg-2 mb-1">
                    <div class="card bigHeight bg-pink text-white">
                        <svg class="card-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.61 382.57"><defs>
                ...
                <div class="col-sm-4 col-md-4 col-lg-2 mb-1">
                    <div class="card bigHeight bg-orange text-white">
                        <svg class="card-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.61 382.57"><defs>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <a href="#" class="text-dark no-decor">
                            <div class="card midHeight bg-darks text-white d-flex align-content-between flex-wrap">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <a href="#" class="text-dark no-decor">
                            <div class="card midHeight bg-pink d-flex align-content-between flex-wrap">
                                <div class="card-header w-100 pan">
                                    НЕ ПОПАЛ?
                                </div>
                                <div class="col mb-auto">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <a href="#" class="text-dark no-decor">
                            <div class="card midHeight bg-orange d-flex align-content-between flex-wrap">
                                <div class="card-header w-100 pan">
                                    КУПИ ПЛЗ МЯЧ!
                                </div>
                                <div class="col mb-auto">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <a href="#" class="text-dark no-decor">
                            <div class="card midHeight bg-dark text-white d-flex align-content-between flex-wrap">
                                <div class="card-header w-100 pan">
                                    8 ТИПОВ ПОКРЫТИЙ
                                </div>
                                <div class="col mb-auto">
            ...
            <div class="offset-artem-designer-2019">
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <a href="#" class="text-dark no-decor">
                            <div class="card midHeight bg-light">
        ...
        <div class="container-fluid subscribe mt-3">
            <div class="container">
                <div class="row smalHeight d-flex align-items-center">
...
<!--             pt-4-->
            <div class="row btm_links">
                ...
                <div class="col-12">
<!--                     mb-4-->
                    <h3 class="text-center">ОЦЕНИТЕ НАС 
        ...
        <footer class="">
            <div class="container">
                <div class="row text-white">
                    ...
                    <p class="w-100 lead myr text-center p-2">&COPY; <?php echo date("Y"); ?> SLAMDUNK</p>
                </div>
            </div>
        </footer>
        <!-- ~~~~~~ END FOOTER ~~~~~ -->
