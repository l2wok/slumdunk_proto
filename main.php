        ...
        <main class="mb-auto">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-interval="10000">
                        ...
                        <div class="carousel-caption">
                            ...
                            <button class="btn btn-black" onclick="jQuery(alert('Клик на СМОТРЕТЬ КАТАЛОГ'))">СМОТРЕТЬ КАТАЛОГ</button>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="mid-btn-block">
                    <button class="btn btn-black" onclick="jQuery(alert('Клик на Новые Поступления'))">НОВЫЕ ПОСТУПЛЕНИЯ</button>
                </div>
                ...
                <div class="mid-btn-block">
                    <button class="btn btn-black" onclick="jQuery(alert('Клик на КОЛЛЕКЦИИ'))">КОЛЛЕКЦИИ</button>
                </div>
                <!-- BLOG long cards -->
                <div class="row">
                    <div class="col-md-12 col-lg-6 mb-1">
                        <div class="card card-big bg-color-black font-color-smoke font-shadow-black shadow">
                            <img src="assets/img/123456.png" class="img-fluid" alt="">
                    ...
                    <div class="col-lg-2 d-sm-none d-lg-block only-desktop mb-1">
                        <div class="card item_card card-big bg-color-pink">
                    ...
                    <div class="col-lg-2 d-sm-none d-lg-block only-desktop mb-1">
                        <div class="card item_card card-big bg-color-orange">
                            <svg class="card-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.61 382.57"><defs>
                            <style>.fill-dark{fill:#0b0f1b;}</style></defs>
                    ...
                    <div class="col-lg-2 d-sm-none d-lg-block only-desktop mb-1">
                        <div class="card item_card card-big bg-color-light">
                            <svg class="card-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.61 382.57"><defs>
                            <style>.fill-dark{fill:#0b0f1b;}</style></defs>
                ...
                <!-- BLOG short cards -->
                <div class="mid-btn-block">
                    <button class="btn btn-black" onclick="jQuery(alert('Клик на ИЗБРАННЫЕ СТАТЬИ'))">ИЗБРАННЫЕ СТАТЬИ</button>
                </div>
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 my-1">
                        <div class="item_card card-small d-flex flex-column align-items-start card-hover-shadow cursor-pointer" onclick="jQuery(alert('Клик на статью 4'))">
                            <svg class="item-card-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 113.45 114.48" >
                            <defs><style>.cls-bl{fill:#333;}</style></defs><g id="ball_1"><g id="ball_2">
                            <path class="cls-bl" d="M13.72,86.13c.63-18.52,14.38-33.85,28.51-44.35C57.6,30.36,76.94,22.18,96.28,22c2.68,0,2.68-4.17,0-4.15-20.56.17-40.77,8.9-57.08,21-15,11.18-29,27.66-29.64,47.24-.09,2.68,4.06,2.67,4.15,0Z"/>
                            <path class="cls-bl" d="M21.77,12.8c-.37,5.44,1.94,11.46,3.68,16.5A147,147,0,0,0,38.37,56.7C50.5,77,68.51,95.35,92.15,101c2.6.62,3.71-3.38,1.1-4C70.54,91.57,53.7,74,42,54.61A141.65,141.65,0,0,1,29.68,28.82c-1.73-4.85-4.12-10.76-3.75-16,.18-2.67-4-2.66-4.15,0Z"/>
                ...
                <div class="mid-btn-block">
                    <button class="btn btn-black" onclick="jQuery(alert('Клик на ЕЩЕ ТЕБЕ ПОНРАВИТСЯ'))">ЕЩЕ ТЕБЕ ПОНРАВИТСЯ</button>
                </div>
                <!-- LAST Item Block  -->
                <div class="last-block-with-offset">
                    <div class="row no-gutters d-flex justify-content-around">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 card-deck mb-1">
                            ...
                            <div class="card d-flex flex-column align-items-start">
                                <div class="discount"><span class="text-uppercase bg-color-black font-color-smoke">новинка</span></div>
                                <img src="https://www.slamdunk.su/thumbs/5bbbfc774f1ee.jpg" class="card-img" alt="">
                                <div class="card-footer w-100 h-50 mt-auto d-flex flex-column">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6 card-deck mb-1">
                            <div class="card d-flex flex-column align-items-start">
                                <img src="https://www.slamdunk.su/thumbs/5b41df8e50e2c5b400f77b51a6.jpg" class="card-img" alt="">
                                <div class="card-footer w-100 h-50 mt-auto d-flex flex-column">
                            ...
                            <div class="card d-flex flex-column align-items-start">
                                <img src="https://www.slamdunk.su/thumbs/5c7530c89e00dAO6224-004-PHSRH000-2000.jpeg" class="card-img " alt="">
                                <div class="card-footer w-100 h-50 mt-auto d-flex flex-column">
                ...
                <!-- END LAST Item Block  -->
<!--                <div class="mid-btn-block">
                    <button class="btn btn-black" onclick="jQuery(alert('Клик на СМОТРЕТЬ ЕЩЕ'))">СМОТРЕТЬ ЕЩЕ</button>
                </div>-->
            </div>
        </main>
        <!-- END Main -->
