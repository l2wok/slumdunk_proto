...
<html lang="ru">
    ...
    <body class="d-flex flex-column h-100">
        ...
        <main class="mb-auto">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3 mb-1">
                        <div class="cursor-pointer" onclick="jQuery(alert('Клик на карточку товара 4'))">
                            <div class="item_card card-big card-hover-shadow d-flex">
                    ...
                    <div class="col-lg-2 d-sm-none d-lg-block only-desktop mb-1">
                        <div class="card item_card card-big bg-color-pink ">
                            ...
                            <div class="card-img-overlay d-flex align-items-end justify-content-center">
                                <button class="btn btn-dark bg-color-black">ПОДРОБНЕЕ</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 d-sm-none d-lg-block only-desktop mb-1">
                ...
                <!-- BLOG short cards -->
                <div class="midBtn">
                    <button class="btn btn-dark bg-color-black" onclick="jQuery(alert('Клик на ИЗБРАННЫЕ СТАТЬИ'))">ИЗБРАННЫЕ СТАТЬИ</button>
                </div>
                <div class="row">
                            ...
                            <div class="card d-flex flex-column align-items-start">
                                ...
                                <div class="card-footer w-100 h-50 mt-auto d-flex flex-column">
                                    ...
                                    <div class="w-100 d-flex align-items-center mt-auto">Цена: 10 790р.
                                        <button class="btn btn-sm btn-dark bg-color-black ml-auto">Купить</button>
                                    </div>
                                </div>
                            </div>
                            <div class="card d-flex flex-column align-items-start">
        ...
        <!-- subscribe block -->
        <div class="w-100 bg-color-black mb-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="col-md-5 col-lg-3 my-3">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn bg-color-orange font-color-light border-dark" type="button">
